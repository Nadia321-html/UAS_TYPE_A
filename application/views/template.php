                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url() . 'kategori' ?>">
                            <i class="fa fa-desktop"></i> Kategori Barang
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url() . 'operator' ?>">
                            <i class="fa fa-desktop"></i> Operator
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url() . 'barang' ?>">
                            <i class="fa fa-desktop"></i> Data Barang
                        </a>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo base_url() . 'transaksi/utama' ?>"><i class="fa fa-edit"></i>Data Transaksi</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url() . 'transaksi' ?>"><i class="fa fa-edit"></i>Proses Transaksi</a>
                            </li>
                        </ul>
                    </li>
                    <li>
